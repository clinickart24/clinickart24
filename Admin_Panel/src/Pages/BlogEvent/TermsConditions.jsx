...
const Aboutus = () => {
    ...
    const handleSave = async () => {
        ...
        setSaveLoading(true);
        const payload = { title, desc: description, userType };
        ...
        <section className="sectionCont">
            <div className="pb-4 w-full flex justify-between items-center">
                <span className="tracking-widest text-slate-900 font-semibold text-2xl">
                    {userType === "USER" ? "Terms And Conditions For User" : "Terms And Conditions For Vendor"}
                </span>
                <select
                    ...
                    <button
                        ...
                        onClick={() => {
                            ...
                            if (existingData) {
                                ...
                                setDescription(existingData.desc);
                    ...
                    <div className="aboutus">
                        ...
                        <div
                            ...
                            dangerouslySetInnerHTML={{
                                __html: response.data.find(item => item.userType === userType)?.desc
                            }}
                        />
                    </div>
                )}
