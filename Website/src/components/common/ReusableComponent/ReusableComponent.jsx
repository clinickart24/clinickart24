    ...
    <div className="flex flex-col md:flex-row items-center justify-between mt-6 px-4 text-sm text-gray-600">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="w-8 h-8 rounded flex items-center justify-center bg-[#f8069d] text-white disabled:opacity-50 cursor-pointer"
        >
        ...
        <button
          ...
          className="w-8 h-8 rounded flex items-center justify-center bg-pink-500 text-white disabled:opacity-50 cursor-pointer"
        >
...
export const ReusableTableComponent = ({ data = [], columns = [] }) => {
  ...
  return (
    <div className="overflow-x-auto bg-[#1C1D27] rounded-sm border border-[#2E2F3D]">
      <table className="min-w-full text-xs white text-">
        <thead className="bg-[#2B2C3B] text-gray-300">
          <tr>
            {columns.map((col) => (
              <th
                key={col.accessor}
        ...
        <tbody>
          {sortedData.map((row, rowIndex) => (
            <tr
              key={rowIndex}
              className="border-b border-[#2E2F3D] hover:bg-[#292b3b]"
            >
              {columns?.map((col) => (
                <td key={col.accessor} className="p-4 text-gray-300">
